...
from backend.app.db.database import _add_soft_delete_filter, get_db
from scripts.seed_data import seed_roles_permissions
...
def _disable_rate_limits():
    ...
    backend.app.dependency_overrides[rate_limiter] = lambda times, seconds: None
    yield
    backend.app.dependency_overrides.pop(rate_limiter, None)
...
def client(db: sessionmaker, clean_redis: None):
    ...
    backend.app.state.force_rate_limiter_init = True
